...
export default class Tab extends Component {
  ...
  constructor(props) {
    ...
    this.state = Tab.copyPropsToState(this.props, {}, this.props.defaultFocus);
  }

  componentWillReceiveProps(newProps) {
    if (
      process.env.NODE_ENV !== 'production' &&
      Tab.inUncontrolledMode(newProps) !== Tab.inUncontrolledMode(this.props)
    ) {
...
For more information about controlled and uncontrolled mode of react-tabs see the README.`);
    ...
    this.setState(state => Tab.copyPropsToState(newProps, state));
  }
  ...
  handleSelected = (index, last, event) => {
    ...
    if (Tab.inUncontrolledMode(this.props)) {
  ...
  static copyPropsToState(props, state, focus = false) {
    ...
    if (Tab.inUncontrolledMode(props)) {
